...
#'   \item{Benefit 2}{Continuous variable representing second benefit measure, correlated with Benefit 1 (r = 0.6)}
#'   \item{Benefit 3}{Continuous variable representing third benefit measure}
#'   \item{Risk 1}{Continuous variable representing first risk measure, correlated with all three benefits (r = 0.3, 0.2, -0.5)}
#'   \item{Risk 2}{Continuous variable representing second risk measure, correlated with benefits and Risk 1}
#'   \item{Risk 3}{Continuous variable representing third risk measure, correlated with all previous variables}
#'   }
#' @details This dataset contains simulated data with all continuous variables and
#' controlled correlation structures. The data is generated using the faux package
#' to create specific correlations between benefit and risk outcomes, demonstrating
#' both positive and negative relationships suitable for correlogram analysis.
"corr2"
