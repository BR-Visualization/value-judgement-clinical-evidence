...
#'     1 = event observed, 0 = censored}
#'   \item{treatment}{Treatment group (character): "Drug A" or "Drug B"}
#' }
#'
#' @details
...
#' - Clinical Response: Moderate onset (mean 30 days)
#' - Quality of Life Improvement: Slower onset (mean 45 days)
#'
#' **Risk Events:**
#' - Mild AE: Can occur anytime (mean 40 days)
#' - Moderate AE: Often later (mean 50 days)
#' - Serious AE: Typically later (mean 70 days)
#'
#' **Censoring:**
#' Approximately 3% of subjects have censored observations due to:
#' - Events occurring after maximum follow-up (180 days)
...
#' summary(time_event_data)
#'
#' # Count subjects by observation status
#' table(
#'   Benefit = time_event_data$benefit_observed,
#'   Risk = time_event_data$risk_observed
#' )
#'
#' # Create scatter plot
#' \dontrun{
